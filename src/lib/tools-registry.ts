...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    isClientSide: true,
    trending: true,
    seoTitle: "Nepal Salary Tax & TDS Calculator (FY 2083/84) – Income Tax Slabs",
    seoDescription: "Calculate Nepal salary tax, monthly TDS withholding, and annual income tax liability with the latest 2083/84 IRD tax slabs, SSF, EPF, and CIT deductions.",
  },
  {
  ...
  },
  {
    ...
    darkColor: "#22C55E",
    isClientSide: false,
    seoTitle: "Gold & Silver Calculator Nepal – Tola, Aana & Lal Live Rates",
    seoDescription: "Calculate live gold and silver prices in Tola, Aana, Lal, and Grams using real-time Nepal FENEGOSIDA rates. Instant 1 Aana & 1 Lal gold price conversion.",
  },
  {
    slug: "sip-calculator",
  ...
  },
  {
    ...
    darkColor: "#F87171",
    isClientSide: true,
    seoTitle: "Nepal Vehicle Tax Calculator – Bike, Car & Blue Book Tax Rates",
    seoDescription: "Calculate motorcycle (bike) tax rates, car road tax, and late blue book renewal penalty fines across all 7 provinces of Nepal. Free and instant.",
  },
  {
