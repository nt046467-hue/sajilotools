...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    isClientSide: true,
    trending: true,
    seoTitle: "Salary Tax & TDS Calculator Nepal (FY 2083/84) – Income Tax Slabs & Deductions",
    seoDescription: "Calculate Nepal salary tax, monthly Salary TDS withholding, and annual income tax liability with the latest 2083/84 IRD tax slabs, SSF, EPF, and CIT deductions.",
  },
  {
  ...
  },
  {
    ...
    darkColor: "#22C55E",
    isClientSide: false,
    seoTitle: "Gold & Silver Calculator Nepal – Live Tola, Aana, Lal Price & Making Charges",
    seoDescription: "Calculate live gold and silver prices in Tola, Aana, Lal, and Grams using real-time Nepal FENEGOSIDA rates. Instant 1 Aana, 1 Lal price and making charge estimation.",
  },
  {
    slug: "sip-calculator",
    tier: "COMMODITY",
  ...
  // ── Nepal ──
  {
    ...
    isClientSide: true,
    trending: true,
    seoTitle: "Nepali Land Area Converter – Ropani, Aana, Paisa, Bigha, Kattha, Sq Ft",
    seoDescription: "Convert between Ropani, Aana, Paisa, Daam, Bigha, Kattha, Dhur, Square Feet, and Square Meters using official Survey Department (नापी विभाग) factors.",
  },
  {
  ...
  },
  {
    ...
    darkColor: "#F87171",
    isClientSide: true,
    seoTitle: "Nepali Number to Words Converter – Lakh, Crore to Words & Numbers",
    seoDescription: "Convert numbers to Nepali words in Devanagari or Nepali words to digits. Supports Cheque amounts, Lakh, Crore, and Kharba conversions with 100% privacy.",
  },
  {
  ...
  },
  {
    ...
    darkColor: "#F87171",
    isClientSide: true,
    seoTitle: "Vehicle Tax Calculator Nepal (FY 2083/84) – Bike & Car Road Tax & Renewal Fines",
    seoDescription: "Calculate motorcycle (bike) road tax rates, car tax, EV discounts, and late blue book renewal penalty fines across all 7 provinces of Nepal. Free and instant.",
  },
  {
